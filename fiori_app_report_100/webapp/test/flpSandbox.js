		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori App Gestão",
									"targetURL": "#brcomgestaofioriappreport100-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappreport100-display": {
								"semanticObject": "brcomgestaofioriappreport100",
								"action": "display",
								"description": "Fiori App Gestão",
								"title": "Fiori App Gestão",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappreport100",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappreport100")
								}
							}
						}
					}
